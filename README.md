...
```
git clone https://github.com/Marc-Sol-degen/Raydium-volume-bot-open-source.git
cd Raydium-volume-bot-open-source
```
...
### Telegram: [@mark_sol_degen](https://t.me/mark_sol_degen)   
